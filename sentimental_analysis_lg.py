...
# Load sentiment dictionary (simple positive and negative word lists)
positive_words = set([
...
# Load the CSV file (make sure to adjust the file name/path as necessary)
df = pd.read_csv('scraped_web_content_lg.csv')
print(df.columns)
print(df.head())


if 'Content' in df.columns:
    # Process the content to get processed sentences
    ...
    # Assuming you have a 'URL' column in your CSV
    if 'URL' in df.columns:
        ...
        # Select relevant columns and rename them for final output
        ...
        final_df.to_csv('prsa_rank_lg.csv', index=False)
