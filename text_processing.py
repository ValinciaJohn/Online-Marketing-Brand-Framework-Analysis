...
# Predefined product terms (e.g., "battery", "camera")
main_terms = ["battery", "camera", "screen", "performance"]

# Relationship terms (e.g., adjectives like "good", "excellent")
relation_terms = ["good", "excellent", "poor", "fast", "slow", "strong", "weak"]

# Read the CSV file containing web page content and URLs
file_path = 'scraped_web_content.csv'  # Path to your CSV file
...
output_file_path = 'url_scores.csv'  # Path for the output CSV file
